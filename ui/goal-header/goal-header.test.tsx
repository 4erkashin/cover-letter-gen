...
describe("GoalHeader", () => {
  it("shows count over target with applications generated copy", () => {
    ...
    expect(
      screen.getByText("3/5 applications generated"),
    ).toBeInTheDocument();
  });
  ...
  it("shows progress dots while the goal is in progress", () => {
    ...
    expect(container.querySelectorAll('[data-progress-dot="true"]')).toHaveLength(
      5,
    );
    expect(
      container.querySelectorAll('[data-progress-dot="true"][data-active="true"]'),
    ).toHaveLength(3);
  });
  ...
  it("shows a check when the goal is reached", () => {
    ...
    expect(
      screen.getByText("5/5 applications generated"),
    ).toBeInTheDocument();
